...
public class testAnimal {
	public static void main(String[] args) {
		...
		IRepositorioAnimal rep = RepositorioAnimal.getInstance();
		Cliente c = new Cliente("101.575.184-93", aniversario, "Lucas", end );
		...
		IRepositorioAnimal repoAnimal = RepositorioAnimal.getInstance();
		Endereco ende = new Endereco();
		Cliente dono = new Cliente("2938249", aniversario, "Raissa",  ende);
