				...
				do{
					...
					case 1:
						...
						if(clienteRepositorio.buscar(cpf) == null){
							...
							System.out.println("Erro!! Cliente ja é cadastrado no sistema\n");
						}
						break;
			...
			case 3:
				...
				do{
					...
					case 1:
						...
						}else{System.out.println("Erro!! Produto já se encontra no sistema\n");}
						break;
					case 2:
			...
			case 4:
				...
				do{
					...
					case 1:
						...
						System.out.print("Informe a entrada (dd-mm-aaaa/hh:mm): ");
						dataEntrada = scanner.next();
						
						DateTimeFormatter DATE_FORMAT = DateTimeFormatter.ofPattern("dd-MM-yyyy/hh:mm");
						LocalDateTime entrada = LocalDateTime.parse(dataEntrada, DATE_FORMAT);	
						...
						}else{System.out.println("Funcionario já existe no sistema\n");}
						break;
					case 2:
						System.out.println("Informe o CPF: ");
						cpf = scanner.nextLine();
