		...
		do {
			...
			case 1:
				...
				case 1:
					...
					System.out.print("Digite a data de nascimento do cliente (xx/xx/xxxx): ");
					String data = scanner.nextLine();

					//DateTimeFormatter formatador = DateTimeFormatter.ofPattern("dd/MM/yyyy");
					//LocalDate aniversario = LocalDate.parse(data, formatador);
					//System.out.println("Data: " + aniversario.getDayOfMonth() + " " + aniversario.getMonthValue() + " " + aniversario.getDayOfYear());
